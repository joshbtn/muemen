 ...
 * @param {Bool} showInMenu this determines weather or not the page will show up in the pages context.
 * @api public
 */
 
exports.addPage = function(userName, pageName, markup, context, showInMenu){
